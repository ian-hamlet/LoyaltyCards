...
- [ ] **`develop` merged to `main` branch** — not yet confirmed; this build was delivered to TestFlight outside this document's tracked workflow (same as v2.1.0+27/v2.1.1+28), so there's no record here of whether a `main` merge or release branch preceded it
- [ ] **Release branch created** `releases/v2.1.1-build29` — not yet confirmed, see note above
