...
**Current:** v0.3.0+1 in production  
...
**Current:** v0.3.0+1 on TestFlight  
...
- In code: `0.3.0+1` (no 'v' prefix)
- In docs: `v0.3.0+1` or `Version 0.3.0+1` (with 'v' or 'Version' prefix for clarity)
