...
- **Target Build:** v2.1.1+28 (v2.1.0+27 carried this fix but was never built/uploaded - superseded by v2.1.1+28, which also adds DECISION-017. v2.1.0+26 was already built and uploaded to TestFlight without this fix before it was found, and Apple doesn't allow re-uploading a build number with different content)
...
- **Target Build:** v2.1.1+28 (patch bump from v2.1.0+27, which was committed but never built/uploaded - see TEST-021's own Target Build note)
