...
- **Real-Device Verification:** ⏳ Pending - v2.1.1+29 built and delivered to TestFlight 2026-08-18. Automated-test verified only so far; on-device confirmation not yet run. See `docs/testing/TEST-022_VALIDATION_TEST_PLAN.md`.
