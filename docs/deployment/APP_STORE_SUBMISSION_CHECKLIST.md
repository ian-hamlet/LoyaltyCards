...
**v2.2.1+36 (submitted for App Store review 2026-08-27 — awaiting Apple's review decision):**
...
- [ ] **Approved and released** — pending Apple's review decision
- [x] **v2.2.0+32 status** — already approved and released 2026-08-24; v2.2.1+36 will supersede it once approved and released, as a reliability/bug-fix release (no new App-Store-facing capability)
...
7. [ ] **Monitor review status** — pending
8. [ ] **Respond to App Review** if questions arise
9. [ ] **Release approved apps**
