...
**LoyaltyCards - Initial Baseline: v0.2.0 Build 21, Current: v1.0.0+6 Build 6**  
**Platform:** iOS 13.0+  
...
**Note:** These measurements represent the initial baseline captured at Build 21. Performance characteristics remain consistent from v0.3.0+1 Build 23 through v1.0.0+6 Build 6 (security fixes, package updates, and bug fixes did not impact performance metrics).
