...
- **Notes:** Merged `feature/businessedit` → `develop` → `main` 2026-08-23 (fast-forward), release branch `releases/v2.2.0-build32` cut. Full design discussion, including the rejected alternatives for the `stampsRequired` propagation question, lives in `docs/project-management/Requirements/DISCUSSION_Business_Field_Editing.md`.
