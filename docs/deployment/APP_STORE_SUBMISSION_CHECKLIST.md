...
**v2.0.3+23 (live on the App Store, superseded by v2.0.4+24) — complete, but contains TEST-016:**
...
- ⚠️ **Contains TEST-016** — businesses with 3 or 4 required stamps can't issue a valid card. Fix in progress on `develop` as v2.0.4+24 - build, test, and submit as soon as possible.

**v2.0.4+24 (current) — in progress:**

- [x] **Final build number incremented** in pubspec.yaml (both apps) — `2.0.4+24`, confirmed in `source/{customer_app,supplier_app,shared}/pubspec.yaml`
- [x] **Version number confirmed** — v2.0.4+24 (patch version bump from 2.0.3 -> 2.0.4, per user decision 2026-08-16)
- [x] **Fix merged to `develop`** — TEST-016 fix (`fix/TEST-016-stamps-required-minimum-mismatch`, merged and branch deleted)
- [ ] **All code merged to `main` branch**
- [ ] **Release branch created** `releases/v2.0.4-build24`
- [ ] **Archive builds completed** for v2.0.4+24 — use `source/build_both_apps.sh`
...
- [ ] **Metadata entered into App Store Connect** — What's New only, from `APP_STORE_METADATA_PACKET_v2_0_4_24.md`; all other fields unchanged from v2.0.3+23 and already live
...
9. [x] **Release approved apps** — both apps manually released 2026-08-16, live on the App Store. ⚠️ Contains TEST-016 - build/submit v2.0.4+24 as soon as possible.
...
4. [ ] **Complete all required fields** in App Store Connect — only What's New needs updating (`APP_STORE_METADATA_PACKET_v2_0_4_24.md`); everything else already live from v2.0.3+23
