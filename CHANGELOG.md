...
**Status:** 🟢 **LIVE ON THE APP STORE** (both apps) - built, uploaded, TestFlight-tested (Sharing feature and both bug fixes confirmed working), submitted for App Store review 2026-08-15, and approved and released 2026-08-16. **⚠️ Contains TEST-016** (see 2.0.4+24 above) - supersede with that build as soon as possible. Supersedes 2.0.3+22, which never produced an uploaded build; everything below is the complete state of the 2.0.3 line so far.
