...
**Current Version:** v1.0.1+7 (Release Candidate)  
...
**Checklist:**
- [ ] Update customer_app/pubspec.yaml to `1.0.1+7`
- [ ] Update supplier_app/pubspec.yaml to `1.0.1+7`
...
- [ ] Version updated to 1.0.1+7 in both apps
