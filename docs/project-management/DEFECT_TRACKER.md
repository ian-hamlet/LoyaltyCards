...
- **Status:** ✅ FIXED (guard added to confirmed crash site; same audit found and fixed 5 more instances of the identical gap) - pending App Review / TestFlight re-verification
- **Priority:** CRITICAL
