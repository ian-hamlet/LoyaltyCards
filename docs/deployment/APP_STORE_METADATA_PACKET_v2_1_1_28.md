...
**Status: IN PROGRESS - not yet built or uploaded. Patch version bump (2.1.0 -> 2.1.1), not build-only - v2.1.0+27 shipped TEST-021 to TestFlight the night of 2026-08-16/17, but DECISION-017 didn't exist yet at that point - it was designed and added afterward.**
